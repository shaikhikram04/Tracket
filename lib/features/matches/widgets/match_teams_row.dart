      ...
      children: [
        ...
        Expanded(
          child: _buildMatchTeamColumn(
            ...
            isInningStarted: match.team1Score != null,
            runs: match.team1Score?.runs,
            wickets: match.team1Score?.wickets,
            oversDisplay: match.team1Score?.oversDisplay,
        ...
        Expanded(
          child: _buildMatchTeamColumn(
            ...
            isInningStarted: match.team2Score != null,
            runs: match.team2Score?.runs,
            wickets: match.team2Score?.wickets,
            oversDisplay: match.team2Score?.oversDisplay,
            alignment: CrossAxisAlignment.center,
          ),
        ),
      ],
