...
import 'package:tracket/features/matches/widgets/opening_batsman_sheet.dart';
                ...
                _openers.isEmpty
                    ? InkWell(
                        onTap: () => _showOpeningBatsmenSheet(
                            match.getBattingTeamPlayersBeforeInnStart()),
                        child: Container(
                          height: 100,
                ...
                _bowler == null
                    ? InkWell(
                        onTap: () => _showOpeningBowlerSheet(
                            match.getBowlingTeamPlayersBeforeInnStar()),
                        child: Container(
                          height: 100,
                          decoration: BoxDecoration(
                            color: primaryLight.withValues(
