class FallOfWicket {
  ...
  static int calculatePartnership(FallOfWicket current, FallOfWicket? previous) {
    if (previous == null) {
  ...
  static int calculatePartnershipBalls(FallOfWicket current, FallOfWicket? previous) {
    if (previous == null) {
  ...
  static double partnershipRunRate(FallOfWicket current, FallOfWicket? previous) {
